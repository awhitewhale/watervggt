...
class TrainLabeled(data.Dataset):
    def __init__(self, dataroot, phase, finesize):
        ...
        self.dir_A = self.root + 'train/heavy_snow'
        self.dir_B = self.root + '/train/GT'
        self.dir_C = self.root + '/train/GT'
...
class TrainUnlabeled(data.Dataset):
    def __init__(self, dataroot, phase, finesize):
        ...
        self.dir_A = self.root + '/train/heavy_snow'
        self.dir_C = self.root + '/train/GT'
        self.dir_D = self.root + '/train/heavy_snow'
...
class TestData(data.Dataset):
    def __init__(self, dataroot):
        ...
        self.dir_C = os.path.join(self.root)
